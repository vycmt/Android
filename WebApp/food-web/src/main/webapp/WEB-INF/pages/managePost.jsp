...
<body onload="getFood()">
  <div class="row">
                      ...
                      <tr id="${item.foodId}" class="thisrow">
                        ...
                        <td width="80px">
                          <div class="btn-group1">
                            <button class="btn btn-xs btn-primary btn-check" value="${item.foodId}">
                              <i class="fa fa-check"></i>
                            </button>
                            <button class="btn btn-xs btn-sucess" value="${item.foodId}">
                        ...
                        <td><input type="checkbox" id="selectedFood" class="checkBox" value="${item.foodId }"></td>
                      </tr>
                    </c:forEach>
                  </tbody>
                </table>
              ...
              <tr>
                ...
                <td>
                  <!-- <img id="imageFood" src="" alt="Smiley face"
								height="240" width="480"> --> <a id="imageZoom" class="prettyPhoto[pp_gal]"><img id="imageFood" alt=""
    ...
    <div id="myModalCatelogue" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
      aria-hidden="true">
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header">

...
<link href="<c:url value="/resources/css/metisMenu.min.css" ></c:url>" rel="stylesheet">


<!-- Timeline CSS -->
<!-- <link href="../resources/css/timeline.css" rel="stylesheet"> -->
<link href="<c:url value="/resources/css/timeline.css" ></c:url>" rel="stylesheet">
...
<body>
  ...
  <%--   <script src="<c:url value="/resources/js/metisMenu.min.js" ></c:url>"></script> --%>

  <!-- Custom Theme JavaScript -->
  <!--   <script src="../resources/js/sb-admin-2.js"></script> -->
  <script src="<c:url value="/resources/js/sb-admin-2.js" ></c:url>"></script>

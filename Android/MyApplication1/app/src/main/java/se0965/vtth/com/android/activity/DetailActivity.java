 ...
 */
public class DetailActivity extends AppCompatActivity implements OnTaskCompleted {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FoodDetailAsyncLoader loader = new FoodDetailAsyncLoader(this, DetailActivity.this);
